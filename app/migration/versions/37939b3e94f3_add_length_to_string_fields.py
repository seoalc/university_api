...
Revision ID: 37939b3e94f3
Revises: 4e153856e255
Create Date: 2024-12-31 15:33:40.378637
...
revision: str = '37939b3e94f3'
down_revision: Union[str, None] = '4e153856e255'
...
def upgrade() -> None:
    ...
    sa.Column('major_description', sa.String(length=255), nullable=True),
